...
export const detailTextData: HeroTwoBlockProps = {
  ...heroData,
  subText1:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque lacinia eu sit vulputate ultrices facilisi ut id nisl. Varius ullamcorper at dui tempor sed sem. Vitae eget et scelerisque odio blandit vulputate pharetra, amet.',
}
